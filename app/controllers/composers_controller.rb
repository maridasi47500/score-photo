class ComposersController < ApplicationController
  before_action :set_composer, only: %i[ show edit update destroy newscore ]
  ...
  def update
    respond_to do |format|
      if @composer.update(composer_params)
        format.html { redirect_to @composer, notice: "Composer was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to composers_path, notice: "Composer was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def composer_params
      params.expect(composer: [ :name, :country_id ])
    end
end
