...
class ComposersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create composer" do
    assert_difference("Composer.count") do
      post composers_url, params: { composer: { country_id: @composer.country_id, name: @composer.name } }
    end
  ...
  test "should update composer" do
    patch composer_url(@composer), params: { composer: { country_id: @composer.country_id, name: @composer.name } }
