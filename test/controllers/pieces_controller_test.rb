...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference("Piece.count") do
      post pieces_url, params: { piece: { composer_id: @piece.composer_id, pic: @piece.pic, title: @piece.title } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { composer_id: @piece.composer_id, pic: @piece.pic, title: @piece.title } }
